function [y, mem_new, customData] = storeLeaderInformationForFollowerPulse(~, y, mem)
    ...
    leaderPositionCOE = Position("PN",leaderPositionVector).getPositionInKeplerianDepritSpace(@bridgeToDepritSpace).getAs("COE"); % TODO: fix hard coded bridge function - HSC-010
    mem_new = mem;
